...
En Stock tests usamos `PortalJsonAdapter` (`core/app/Stock/Tests/Support/PortalJsonAdapter.php`). Carga `portal_catalog.json` y simula origen `catalog_items` sin BD/HTTP.
