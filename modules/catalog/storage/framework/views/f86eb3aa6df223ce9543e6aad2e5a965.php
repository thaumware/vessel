                    ...
                    <div class="bg-gray-800/50 rounded-2xl border border-gray-700/50 p-6">
                        ...
                        <select x-model="selectedSeeder" class="w-full mb-2 bg-gray-900 border border-gray-700 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
                            ...
                            <?php $__currentLoopData = $seeders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seeder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($seeder); ?>"><?php echo e(class_basename($seeder)); ?></option>
                    ...
                    <div class="bg-gray-800/50 rounded-2xl border border-gray-700/50 overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-700/50">
                            <div class="px-6 py-3 flex justify-between">
                                ...
                                <span class="text-white font-mono text-sm"><?php echo e(PHP_VERSION); ?></span>
                            </div>
                            <div class="px-6 py-3 flex justify-between">
                            ...
                            <div class="px-6 py-3 flex justify-between">
                                ...
                                <span class="text-white font-mono text-sm"><?php echo e(config('app.debug') ? 'Enabled' : 'Disabled'); ?></span>
                            </div>
                            <div class="px-6 py-3 flex justify-between">
                                <span class="text-gray-400">Timezone</span>
                                <span class="text-white font-mono text-sm"><?php echo e(config('app.timezone')); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-800/50 rounded-2xl border border-gray-700/50 overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-700/50">
                            <div class="px-6 py-3 flex justify-between">
                                ...
                                <span class="text-white font-mono text-sm"><?php echo e(config('database.default')); ?></span>
                            </div>
                            <div class="px-6 py-3 flex justify-between">
                                <span class="text-gray-400">Database</span>
                                <span class="text-white font-mono text-sm"><?php echo e(config('database.connections.' . config('database.default') . '.database')); ?></span>
                            </div>
                            <div class="px-6 py-3 flex justify-between">
                                <span class="text-gray-400">Host</span>
                                <span class="text-white font-mono text-sm"><?php echo e(config('database.connections.' . config('database.default') . '.host', 'N/A')); ?></span>
                            </div>
                            <div class="px-6 py-3 flex justify-between">
...
<?php /**PATH I:\work\NetGenius\thaumware\apps\vessel\modules\catalog\app\Admin\Infrastructure/In/Views/dashboard.blade.php ENDPATH**/ ?>